...
export default class Container {
    ...
    constructor() {
        ...
        this.header = new Header(this.eventBus, this.infos.memberNo, this.infos.currentGroupNo);
        ...
        this.eventBus.add('addCard', (columnNo:number, cardContent:string) => {
            ...
            const currentColumnInfo = this.infos.columnInfos.find(columnInfo => columnInfo.columnNo === columnNo);
